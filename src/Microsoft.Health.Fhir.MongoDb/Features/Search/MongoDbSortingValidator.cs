...
namespace Microsoft.Health.Fhir.MongoDb.Features.Search
{
    ...
    internal class MongoDbSortingValidator : ISortingValidator
    {
        ...
        public bool ValidateSorting(
            IReadOnlyList<(SearchParameterInfo searchParameter, SortOrder sortOrder)> sorting,
            out IReadOnlyList<string> errorMessages)
        {
            ...
            switch (sorting)
            {
                ...
                case { Count: 1 }:
                    ...
                    errorMessages = [string.Format(CultureInfo.InvariantCulture, Microsoft.Health.Fhir.Core.Resources.SearchSortParameterNotSupported, parameter.searchParameter.Code)];
                    return false;
                default:
                    errorMessages = [Microsoft.Health.Fhir.Core.Resources.MultiSortParameterNotSupported];
                    return false;
            }
        }
    }
